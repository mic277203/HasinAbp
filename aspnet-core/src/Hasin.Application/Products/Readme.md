...
复制以下代码到Application层下的：HasinApplicationModule.cs
...
如果你生成了**权限功能**。复制以下代码到 HasinApplicationModule.cs
中的 PreInitialize 方法中:
...
<text name="CategoryId">CategoryId</text>
<text name="Category">Category</text>
<text name="CreatorUserId">CreatorUserId</text>
<text name="CreationTime">CreationTime</text>
<text name="LastModifierUserId">LastModifierUserId</text>
<text name="LastModificationTime">LastModificationTime</text>
<text name="IsDeleted">IsDeleted</text>
<text name="DeleterUserId">DeleterUserId</text>
